...
RSpec.describe 'the veterinarian update' do
  it "shows the veterinarian edit form" do
    shelter = Shelter.create(name: 'Hollywood shelter', full_address: 'Irvine, CA', foster_program: false, rank: 7)
  ...
  context "given valid data" do
    it "submits the edit form and updates the veterinarian" do
      shelter = Shelter.create(name: 'Heavenly pets', full_address: 'Aurora, CO', foster_program: true, rank: 7)
  ...
  context "given invalid data" do
    it 're-renders the edit form' do
      shelter = Shelter.create(name: 'Heavenly pets', full_address: 'Aurora, CO', foster_program: false, rank: 7)
